...
| Version | Fecha      | Autor             | Descripcion |
| ------- | ---------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| TF      | 05/07/2025 | Estefano Jaque    | COMPLETAR |
| TF      | 05/07/2025 | John Arévalo      | COMPLETAR |
| TF     | 05/07/2025  | Diego Rosado | Desarrolle la entrevista para el segundo segmento objetivo coordinadora de RSE y las heurísticas según el análisis de las entrevista. |
| TF      | 05/07/2025 | Sebastian Real    | COMPLETAR |
...
![alt text](assets/images/trellotp.png) 
...
| US01           | Selección de empresa durante el registro |**TA001**            | Integración visual con formulario de sign-up | Conectar subida de documentos al flujo existente en `/sign-up` usando DTO extendido               | 2                      | Estefano Oscar Jaque Peña   | Done       |
|                |                                          | **TA002**            | Respuesta backend con campos de verificación | Mostrar `proofingEntrepreneure` del backend tras registro exitoso                                 | 1                      | Estefano Oscar Jaque Peña   | Done       |
| US02           | Validación automática de datos laborales | **TA003**            | Desarrollo de integración con API Backus     | Implementar servicio para verificar código de colaborador (compañía, DNI, código)                 | 4                      | Estefano Oscar Jaque Peña   | Done       |
|                |                                          | **TA004**            | Validación corporativa dinámica              | Crear lógica para seleccionar tabla `{compania}_colaboradores` y validar contra DB                | 3                      | Estefano Oscar Jaque Peña   | Done       |
|                |                                          | **TA005**            | Control de flujo ante error de validación    | Implementar excepción `InvalidColaboradorException` y mensaje claro al usuario final              | 2                      | Estefano Oscar Jaque Peña   | Done       |
| US16           | Visualización de información clave       | **TA006**            | Diseño de tarjetas interactivas              | Crear 3 tarjetas con íconos + texto responsive para sección "Cómo funciona"                       | 3                      | John Telesforo Arevalo Meza | Done       |
|                |                                          | **TA007**            | Implementar sección de características       | Crear cards con íconos explicando beneficios clave usando diseño en 3 columnas                    | 3                      | John Telesforo Arevalo Meza | Done       |
|                |                                          | **TA008**            | Agregar animaciones de scroll                | Añadir efectos sutiles al hacer scroll para resaltar información clave                            | 2                      | John Telesforo Arevalo Meza | Done       |
| US18           | Formulario de contacto para empresas     | **TA009**            | Desarrollo de formulario sin autenticación   | Crear formulario con campos: Nombre, Empresa, Email, Consulta                                     | 2                      | John Telesforo Arevalo Meza | Done       |
|                |                                          | **TA010**            | Validación en tiempo real                    | Implementar verificación de formato email y resaltado de campos obligatorios                      | 2                      | John Telesforo Arevalo Meza | Done       |
|                |                                          | **TA011**            | Agregar sección de contacto general          | Incluir correo, número telefónico y ubicación física en footer o sección dedicada                 | 1                      | John Telesforo Arevalo Meza | Done       |
| US19           | Adaptabilidad móvil                      | **TA012**            | Implementación de menú hamburguesa           | Crear menú responsive con animación y overlay oscuro para móviles                                 | 3                      | John Telesforo Arevalo Meza | Done       |
|                |                                          | **TA013**            | Ajustes de viewport                          | Optimizar todos los componentes para pantallas <768px con media queries                           | 4                      | John Telesforo Arevalo Meza | Done       |
|                |                                          | **TA014**            | Aplicar diseño responsive global             | Implementar layout mobile-first en todas las secciones con breakpoints y ajustes de CSS           | 4                      | John Telesforo Arevalo Meza | Done       |
|                |                                          | **TA015**            | Optimización de imágenes                     | Comprimir imágenes sin pérdida para mejorar performance en móviles                                | 2                      | John Telesforo Arevalo Meza | Done       |
| US07           | Visualización de postulaciones           | **TA016**            | Desarrollo de endpoint para postulaciones    | Crear API REST (`/api/applications`) que retorne postulaciones con filtrado por estado (query param) | 3                      | John Telesforo Arevalo Meza          | Done     |
|                |                                          | **TA017**            | Componente de lista filtrable                | Implementar vista frontend con dropdown de filtros y cards responsive para cada postulación       | 4                      |John Telesforo Arevalo Meza        | Done      |
|                |                                          | **TA018**            | Modal de detalles completos                  | Crear componente modal que muestre documentos adjuntos, historial y comentarios de evaluadores   | 3                      | John Telesforo Arevalo Meza         | Done      |
| US12           | Publicación de nuevas becas              | **TA019**            | Formulario de registro de beca          | Crear formulario con campos: nombre, requisitos, fecha límite y documentos obligatorios         | 3 | Sebastian Real   | Done |
|                |                                          | **TA020**            | Validación de fecha y requisitos        | Implementar validaciones para asegurar que la fecha sea futura y los requisitos estén completos | 2 |  Diego Rosado   | Done |
|                |                                          | **TA021**            | Vista previa en app móvil               | Generar preview en sección “Nuevas Oportunidades” tras envío exitoso del formulario             | 2 | Diego Rosado | Done       |
| US20           | Vista de becas disponibles de la empresa | **TA022**            | Desarrollo de endpoint listado de becas | Crear endpoint que retorne todas las becas activas con atributos: nombre, tipo, fechas, estado  | 3 |  Diego Rosado  | Done       |
|                |                                          | **TA023**            | Componente frontend de listado          | Diseñar componente en bandeja del administrador que muestre la información detallada            | 3 | Sebastian Real | Done      |
| US21           | Filtro de becas por nombre y tipo        | **TA024**            | Lógica de filtrado backend              | Añadir soporte a filtrado por nombre y tipo en el endpoint de becas                             | 2 | Sebastian Real   | Done      |
|                |                                          | **TA025**            | UI de filtros combinados                | Implementar búsqueda y dropdown por tipo de beca en la interfaz de administración               | 3 | Sebastian Real |Done|
...
¿Cómo describirías tu experiencia inicial al abrir la aplicación por primera vez?

¿El proceso de registro te pareció claro? ¿Hubo algún paso que no entendiste o que te generó dudas?

¿Te sentiste acompañado/a en el proceso o sentiste que algo faltaba para orientarte mejor?

2. Inicio de sesión y pantalla principal

¿Qué fue lo primero que notaste al iniciar sesión? ¿Pudiste identificar fácilmente el propósito de esta pantalla?

¿Te resultó clara la información sobre tus postulaciones activas o pasadas? ¿Qué mejorarías en esa sección?

3. Navegación general

¿Pudiste explorar la app sin ayuda? ¿En algún momento te perdiste o no supiste qué hacer?

¿Qué tan fácil fue encontrar la opción para ver el tutorial dentro del menú hamburguesa? ¿Viste el video? ¿Te ayudó a entender mejor la aplicación?

4. Formulario de Datos del Apoderado

¿Qué opinas del formulario para completar tus datos como apoderado o trabajador?

¿Te pareció muy largo o complicado? ¿Sabrías qué tipo de datos necesitas tener a la mano antes de llenarlo?

5. Añadir postulante y enviar solicitud

¿Cómo fue tu experiencia al añadir a tu hijo o hija como postulante? ¿Fue clara la información que se pedía?

¿El botón para enviar la solicitud fue fácil de encontrar y entender? ¿Te generó confianza que la postulación se haya enviado correctamente?

6. Usabilidad y percepción general

¿La aplicación te pareció rápida, fluida y amigable? ¿Cambiarías algo en la forma en que está presentada?

¿Qué funcionalidades fueron las más útiles para ti? ¿Hubo alguna que no entendiste o que te pareció innecesaria?

7. Seguridad y confianza

¿Qué te haría sentir mayor seguridad al usar esta app (ej: respaldo institucional, mensajes de confirmación, autenticación extra)?

8. Interés y disposición futura
