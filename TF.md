...
| TS02 | Sincronización de Documentos con cloudinary | Como desarrollador, necesito que los documentos subidos se almacenen en cloudinary. | Escenario 1: Subida exitosa de documento.<br>Dado que un usuario sube un archivo credencial.pdf.Cuando el sistema valida que es un PDF.Entonces se guarda en gs://scholr-docs/[user_id]/[timestamp].pdf.<br>Escenario 2: Intento de subida con formato no permitido.<br>Dado que un usuario sube virus.exe.Cuando el sistema detecta la extensión .exe.,entonces rechaza la operación con error 415 Unsupported Media Type.| EP-TECH-02 |
...
|25| TS02 | Sincronización de Documentos con cloudinary | Como desarrollador, necesito que los documentos subidos se almacenen en cloudinary |5 |
...
Asimismo, se finalizó la implementación del módulo **IAM**, tanto en frontend como backend, y se habilitó la **sincronización de archivos con cloudinary**, asegurando el almacenamiento. Gracias al uso de **Trello**, se mantuvo una organización clara del trabajo, permitiendo a cada integrante seguir el estado de sus tareas y resolver bloqueos con agilidad, logrando cumplir los objetivos trazados.
...
| TS02 | Sincronización con cloudinary | TA045 | Configuración y lógica de subida | Configurar almacenamiento en cloudinary y subir archivo con metadatos | 3 | Diego Rosado | Done |
