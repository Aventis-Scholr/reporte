...
| US20|Vista de becas disponibles de la empresa|Como administrador,quiero ver todas las becas activas de mi empresa,para gestionar oportunidades vigentes.|Escenario 1: Listado completo<br>Dado que el administrador accede al módulo "Becas".Cuando el sistema carga la información,Entonces muestra: nombre, tipo, fechas límite, cupos y estado (activa/cerrada).|EP04|
